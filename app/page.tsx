      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 border-t border-gray-200 dark:border-zinc-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedSection animation="fadeUp" delay={200}>
            <div className="flex justify-center gap-6 mb-12">
              <a
                ...
                aria-label="이메일 보내기"
                className={`p-4 bg-gray-50 dark:bg-zinc-900 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors ${focusRing}`}
              >
          ...
          <AnimatedSection animation="scale" delay={300}>
            <Link
              href="/contact"
              className={`inline-block px-8 py-4 bg-blue-600 text-white rounded-lg font-medium hover:opacity-90 transition-opacity ${focusRing}`}
            >
              문의하기
            </Link>
          </AnimatedSection>
