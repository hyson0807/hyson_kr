...
const sections = [
  ...
  },
  {
    ...
    list: [
      '위치 정보',
      '연락처, 통화 기록, 문자 메시지',
      '사진 라이브러리 권한 — 열람 권한도, 추가 권한도 요구하지 않습니다. 배경화면에 쓸 사진은 iOS 시스템 사진 선택기로 고르며, 앱은 이용자가 선택한 한 장만 전달받습니다.',
  ...
  },
  {
    ...
    list: [
      ...
      '생성된 달력 이미지는 이용자의 사진 앨범에 저장되지 않습니다. 단축어가 실행될 때마다 기기 안에서 새로 만들어져 잠금화면에 바로 적용되며, 앨범에는 아무것도 남지 않습니다.',
  ...
  },
  {
    ...
    list: [
      ...
      '탈퇴는 앱의 설정 › 계정 관리 › 계정 삭제에서 즉시 진행할 수 있으며, 별도의 요청 절차가 필요하지 않습니다.',
  ...
  },
  {
    ...
    list: [
      ...
      '이용자는 앱의 설정 › 계정 관리 › 계정 삭제로 언제든지 이용 계약을 해지하고 개인정보 삭제를 요청할 수 있습니다.',
